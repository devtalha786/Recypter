...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fffcf1] text-white pt-24">
      ...
      <section className="py-16 mb-12 px-4 bg-[#393274] text-white">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <h3 className="text-2xl font-bold text-white">
              Join our Discord for updates, support, and feedback!
            </h3>
          </div>
          <Button
            className="bg-[#6259b5] hover:bg-[#6259b5]/60  text-white px-12 py-6 text-lg"
            onClick={() => route.push("https://discord.gg/cXq93Z7yDA")}
          >
            Join
          </Button>
        </div>
