...
const OfferSubscriptionContent = () => {
  ...
  const subscriptionPlans = [
    {
      title: "$1.99 Per Receipt",
      type: "Per Receipt",
      service: "Email Receipt Generator",
      features: [
        "Stockx",
        "Apple",
        "GOAT",
      ...
      <div className="py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6  mx-auto">
          {subscriptionPlans?.map((plan, index) => (
            ...
            >
              <div>
                <h3 className="text-[26px] font-bold text-[#6259b5] mb-4">
                  {plan?.title}
                </h3>
